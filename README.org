...
These signal captured may be audio, in which case, these modules act as a loop recorder
...
and record and sequence parameter automation, or control voltage, for example.
