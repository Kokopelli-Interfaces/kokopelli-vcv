...
struct Member {
  ...
  inline Member(unsigned int n_beats, std::vector<unsigned int> members_being_observed_idx, tribalinterfaces::dsp::SignalType signal_type, int samples_per_beat) {
    ...
    _love = new Recording(tribalinterfaces::dsp::SignalType::PARAM, samples_per_beat);
  }
