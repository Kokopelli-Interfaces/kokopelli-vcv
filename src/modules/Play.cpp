...
struct PlayWidget : ModuleWidget {
	PlayWidget(Play* module) {
		...
		addInput(createInput<PJ301MPort>(mm2px(Vec(2.398, 82.816)), module, Play::IN_ATTENUATION_INPUT));
...
Model *modelPlay = rack::createModel<Play, PlayWidget>("KokopelliVcv-Play");
