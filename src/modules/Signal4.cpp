...
struct Signal4Widget : ModuleWidget {
	Signal4Widget(Signal4* module) {
		...
		addParam(createParam<RoganHalfPSLightBrown>(mm2px(Vec(1.499, 71.609)), module, Signal4::IN_ATTENUATION_PARAM));
...
Model *modelSignal4 = rack::createModel<Signal4, Signal4Widget>("KokopelliInterfaces-Signal4");
